...
icon="${7:-"/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/com.apple.cinema-display.icns"}" # Parameter 7: Local Icon 
jamfProPolicyID="${8:-"1"}"                                  # Parameter 8: The Jamf Pro ID for the device compliance registration policy
...
message="Please finish setting up your computer by running the Device Compliance Registration policy in Self Service.app. Device compliance is necessary to register ensure your device meets security standards and protocols, helping compliance and maintain the compliance. Click OK to register the device & to get started!"
ONLINE_ICON="https://d8p1x3h4xd5gq.cloudfront.net/59822132ca753d719145cc4c/public/601ee87d92b87d67659ff2f2.png"
