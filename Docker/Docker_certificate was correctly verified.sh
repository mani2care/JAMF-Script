...
#./Docker_certificate was correctly verified.sh /Applications/Docker.app/Contents/Library/LaunchServices/com.docker.vmnetd

#You can also verify files in the /Library/PrivilegedHelperTools folder with:
#./Docker_certificate was correctly verified.sh /Library/PrivilegedHelperTools/com.docker.vmnetd and
#./Docker_certificate was correctly verified.sh /Library/PrivilegedHelperTools/com.docker.socket
